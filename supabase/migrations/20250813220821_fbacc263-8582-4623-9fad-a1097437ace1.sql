...
-- RLS policies pentru popular_countdowns_mv
ALTER MATERIALIZED VIEW public.popular_countdowns_mv ENABLE ROW LEVEL SECURITY;

CREATE POLICY "public_read_popular_countdowns"
ON public.popular_countdowns_mv
FOR SELECT
USING (true);
