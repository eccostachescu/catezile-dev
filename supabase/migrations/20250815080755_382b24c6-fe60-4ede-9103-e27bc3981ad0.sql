...
-- Create some sample movies with poster URLs
INSERT INTO public.movie (tmdb_id, title, poster_url, cinema_release_ro, slug, status) VALUES
(12345, 'Film Fantastic 2025', 'https://images.unsplash.com/photo-1489599510072-12d66b9ac1ae?w=800&h=600&fit=crop', '2025-03-15', 'film-fantastic-2025', 'SCHEDULED'),
(12346, 'Aventura Extraordinară', 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=800&h=600&fit=crop', '2025-04-20', 'aventura-extraordinara', 'SCHEDULED'),
(12347, 'Thriller Românesc', 'https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=800&h=600&fit=crop', '2025-05-10', 'thriller-romanesc', 'SCHEDULED');